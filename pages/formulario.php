...
<head>
    ...
    <link rel="stylesheet" href="../admin/frontend/css/cadastro.css">
        ...
        <div class="container">
            <div class="usuario container__cadastro">
                <div class="container__formulario">
                    <form action="../backend/formulario/fomulario.php" method="POST">
                ...
                <div class="container__img"><img src="../admin/frontend/img/selfie2.jpg" alt="" style="width: 100%;"/></div>
            </div>
        </div>
    </section>
