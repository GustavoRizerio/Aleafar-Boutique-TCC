...
<body>
        ...
        <section class="cabecalho__secao">
            <nav class="secao__navegacao">
                <ul class="navegacao__lista" id="side__menu">
                    ...
                    <li class="navegacao__lista-item">
                        <a href="./cliente.php" class="navegacao__lista-link linkselect">Cliente</a>
                    </li>
                    <li class="navegacao__lista-item">
    ...
    <h1><span class="blue">&lt;</span>Cliente<span class="blue">&gt;</span></h1>
    ...
    <table class="container">
        ...
        <tbody>
            <?php
            //caminho absoluto
            include_once('../../backend/cliente/exibir.php');
            ...
            if ($result) {
                while ($user_data = mysqli_fetch_assoc($result)) {
                    ...
                    echo "<td>
                            ...
                            <a class='btn btn-sm btn-danger' href='../../backend/cliente/delete.php?id=$user_data[ID]' title='Deletar'>
