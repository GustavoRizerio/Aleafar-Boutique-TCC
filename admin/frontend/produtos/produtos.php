...
<body>
    ...
    <h1 style="margin-top: 30px;"><span class="blue">&lt;</span>Produtos<span class="blue">&gt;</span></h1>
    ...
    <table class="container">
        ...
        include_once('../../backend/produtos/exibir.php');
        ...
        while ($user_data = mysqli_fetch_assoc($result)) {
            ...
            echo "<td>
                        <a class='btn btn-sm btn-primary' href='./edit.php?id=$user_data[ID]' title='Editar'>
                            ...
                            <a class='btn btn-sm btn-danger' href='../../backend/produtos/delete.php?id=$user_data[ID]' title='Deletar'>
